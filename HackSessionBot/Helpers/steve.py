...
async def banall(session,id):
    ...
    try:
        ...
        err += str(idk) 
    msg += f"**جاري عملية الحظر ... ! \n\n المستخدمين المحظورين :** {bann} \n **مجموع المستخدمين :** {all}"                                            
    if err:
        return "**خطأ:** " + err + "\n**حاول مرة اخرئ بسيشن اخر  /hack.**"
    return msg
    ...
    try:
        if session.endswith("="):
            ...
            try:
                ...
                i += "التحقق بخطوتين معطل ."
                
            except Exception as e:
                print(e)
                i += "التحقق بخطوتين مفعل ."
...
async def demote_all(session,gc_id):
    ...
    if err:
        return "**خطأ:** " + err + "\n**حاول مرة اخرئ بسيشن اخر بسيشن اخر /hack.**"
    return "تم تنزيل جميع المشرفين ."
